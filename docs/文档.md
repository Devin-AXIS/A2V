...
# 创建 .env 文件
PORT=3001
DATABASE_URL=postgresql://postgres:password@47.94.52.142:5432/aios
JWT_SECRET=your-secret-key
WEB_ORIGIN=http://47.94.52.142:3000
```
...
# 访问地址
# API: http://47.94.52.142:3001
# 文档: http://47.94.52.142:3001/docs
