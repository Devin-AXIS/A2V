...
"[project]/new-flow/A2V/app/api/upload-image/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const uniqueFilename = `${(0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomBytes"])(16).toString('hex')}${fileExtension}`;
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(UPLOADS_DIR, uniqueFilename);
        // 将文件保存到磁盘
...
//# sourceMappingURL=%5Broot-of-the-server%5D__375274fa._.js.map