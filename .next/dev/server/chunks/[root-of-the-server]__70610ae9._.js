...
"[project]/new-flow/A2V/app/api/proxy/[configId]/resources/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function createTemporarySession(configId, config) {
    console.log(`[Proxy Resources] 创建临时会话，configId: ${configId}`);
    ...
    console.log(`[Proxy Resources] 临时会话连接成功，configId: ${configId}`);
    // 保存临时会话
...
async function GET(request, { params }) {
    try {
        ...
        if (!mcpClient) {
            try {
                console.log(`[Proxy Resources] 未找到现有会话，尝试创建临时会话，configId: ${configId}`);
                mcpClient = await createTemporarySession(configId, config);
            } catch (error) {
                console.error(`[Proxy Resources] 创建临时会话失败:`, error);
                return __TURBOPACK__imported__module__$5b$project$5d2f$new$2d$flow$2f$A2V$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$0_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
        ...
        console.error('[Proxy Resources] 获取资源列表失败:', error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__70610ae9._.js.map