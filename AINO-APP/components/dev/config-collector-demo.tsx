...
import { Loader2, Download, CheckCircle, XCircle, AlertTriangle, Info } from 'lucide-react'
import {
    collectAllConfigs,
...
export function ConfigCollectorDemo() {
    ...
    const handleExportConfigs = () => {
        ...
        try {
            if (configs.system) {
                exportConfigsToJson(configs.system, 'aino-system-configs.json')
            } else if (configs.local || configs.api) {
                exportConfigsToJson(configs, 'aino-complete-configs.json')
            }
        } catch (err) {
    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold">AINO配置采集器演示</h1>
                            ...
                            {configs?.system ? (
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-medium mb-2">APP配置</h4>
                                            <div className="space-y-1 text-sm">
