    ...
    try {
      ...
      const response = await api.fields.createField({
        ...
        schema: {
          ...
          ...(fieldData.metaItemsConfig && { metaItemsConfig: fieldData.metaItemsConfig }),
      ...
      if (response.success && response.data) {
        ...
        const newField = {
          ...
          metaItemsConfig: response.data.schema?.metaItemsConfig || undefined,
    ...
    try {
      ...
      const response = await api.fields.updateField(id, {
        ...
        schema: {
          ...
          metaItemsConfig: fieldData.metaItemsConfig || undefined,
